<template>
  <div id="edit">
    <el-container>
      <el-header style="min-height:100px;height:auto;border:1px solid">
      ...
      <el-container>
        <el-aside style=" width:300px;border:1px solid" >
        ...
        <el-container style="border:1px solid" >
          <el-main>
            <div class="edit-main-right">
              <mavon-editor v-model="mdText" @change="changeMdEditor"/>
            </div>
          </el-main>
